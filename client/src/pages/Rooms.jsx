    ...
    >
      ...
      <div className="rooms-container">
        ...
        >
          ...
          <p>Explore our selection of meticulously designed rooms, each offering a unique blend of comfort and luxury.</p>
        </motion.div>
              ...
              >
                <div className="modal-content">
                  <div className="modal-header">
                    <h5 className="modal-title">{selectedRoom.type || "Unnamed Room"}</h5>
                    <motion.button 
                      type="button" 
                      className="btn-close" 
                      onClick={handleCloseModal}
                  ...
                  <div className="modal-body">
                    <div className="row">
                      ...
                      <div className="col-lg-6">
                        <h3>{selectedRoom.type || "Unnamed Room"}</h3>
                        <p className="lead">${selectedRoom.price || 0} per night</p>
                        <p>{selectedRoom.description || "No description available."}</p>
                        
                        <div className="d-flex justify-content-around my-4">
                            <div className="text-center">
                                <FaRulerCombined className="h4 text-primary"/>
                                <p>{selectedRoom.size || 0} m²</p>
                            </div>
                            <div className="text-center">
                                <FaUsers className="h4 text-primary"/>
                                <p>{selectedRoom.capacity || 0} Guests</p>
                            </div>
                            <div className="text-center">
                                <FaBed className="h4 text-primary"/>
                                <p>{selectedRoom.beds || 1} Bed(s)</p>
                            </div>
                        </div>

                        <h5>Amenities</h5>
                        <ul>
                          {Array.isArray(selectedRoom.amenities) && selectedRoom.amenities.map((amenity) => (
